...
export function NextArrow(props: any) {
    ...
    return (
            ...
            <button className={className} onClick={onClick} style={{...style, width: "auto", height: "auto", left: "100%", top: "-50%"}}>
...
export function PrevArrow(props: any) {
    const { onClick, className, style } = props;
    return (
        <button className={className} onClick={onClick} style={{...style, position: "absolute", right: "-30px", top: "50%", transform: "translateY(-50%)"}}>
            <svg width="14" height="24" viewBox="0 0 14 24" fill="none" xmlns="http://www.w3.org/2000/svg">
