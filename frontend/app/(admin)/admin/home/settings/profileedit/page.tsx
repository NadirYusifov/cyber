    ...
    <section className="w-full mt-5">
      <div className="container mx-auto px-4">
        ...
        <div className="w-full lg:w-1/2 mx-auto rounded-lg border border-zinc-700 p-10">
          ...
          <form className="relative w-full flex flex-col lg:gap-x-3 pt-7">
            <label htmlFor="Email">{t("name")}:</label>
            <input onChange={(e) => e.target.value} className="outline-none border-1 border-zinc-500 px-3 py-1 mt-1 rounded-sm" type="email" />
            <div className="relative mt-5">
              <label htmlFor="Password">{t("password")}:</label>
              <input onChange={(e) => e.target.value} className="relative w-full outline-none border-1 border-zinc-500 px-3 py-1 mt-1 rounded-sm" type={showPassword ? "text" : "password"} />
